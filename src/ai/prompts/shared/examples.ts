/**
 * ================================================================
 * Few-shot 示例数据 — 正反例帮助 LLM 理解正确的行为边界
 *
 * 【用途】用于 FewShotChatMessagePromptTemplate 或在模板中手动注入
 * 【包含的示例】
 *   - CLASSIFICATION_EXAMPLES: 意图分类正反例（解决"写了什么web软件"
 *     被误判为替换操作的常见问题）
 *   - EXECUTION_STYLE_EXAMPLES: 执行风格正反例（规范工具操作日志的中文表达）
 * ================================================================
 */
